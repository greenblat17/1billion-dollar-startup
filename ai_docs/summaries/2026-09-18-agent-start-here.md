...
Next work on `feature/back-for-mobile`: live CMP on current screens — [`plans/2026-09-19-mobile-mvp-backend.md`](../plans/2026-09-19-mobile-mvp-backend.md). Do not deploy that branch to the prod bot host.
...
- Live CMP backend plan: `ai_docs/plans/2026-09-19-mobile-mvp-backend.md`
