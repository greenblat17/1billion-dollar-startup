...
| 2 | Home | [02-home.png](screens/02-home.png) | «Привет, Алекс!», карточка «Начать разговор», чипы темы, «Последний разговор». Нижних табов нет |
...
| 10 | Профиль | [10-profile.png](screens/10-profile.png) | Аккаунт, язык, голос репетитора, CC по умолчанию, микрофон, юр.ссылки, выход. Без табов; back в шапке |
...
- История на макете — список сессий с урезанными баллами. В клиенте отложена; на Home остаётся карточка «Последний разговор».
